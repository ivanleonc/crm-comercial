...
// Usar las rutasa<z za clientes, protegidas por el middleware de autenticación
app.use('/api/clientes', clientesRoutes);

const PORT = 3000;
// --- RUTAS DE AUTENTICACIÓN ---

// 1. REGISTRO DE USUARIO (Idealmente, solo un Admin debería poder crear otros usuarios)
...
// 3. OBTENER USUARIOS (Para el select del ModalRegistro)
